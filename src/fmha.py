...
import math
import numpy as np
from cuda.tile import RoundingMode
...
if __name__ == "__main__":
    ...
    from ir_dump.shape_check import _get_ops_for_shapes_info
    ...
    code = dumper.compile_kernel(fmha_kernel, args, "fmha")

    # ops = _get_ops_for_shapes_info(fmha_kernel, args)
    # for op in ops:
